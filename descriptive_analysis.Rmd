...
# create new data frame to summarize
names <- list(names(hep_binary))
df <- data.frame(names, OI, Survival, Death, p, OR)
names(df) <- c("", "Overall Incidence", "Survival", "Death")
df
```
